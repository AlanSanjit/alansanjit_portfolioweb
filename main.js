...
function renderPanels() {
    ...
    panelsData.forEach(panel => {
        ...
        html += [
            ...
            '        </div>',
            '        <div class="panel-content-detail absolute inset-0 z-30 flex flex-col justify-center items-start text-left p-6 sm:p-8 md:p-12 lg:p-20 ' + panel.bgColor + ' backdrop-blur-sm text-white">',
            '            <h2 class="font-display text-4xl md:text-6xl lg:text-8xl mb-4 md:mb-6">' + panel.title + '</h2>',
            '            <p class="font-display text-base md:text-xl lg:text-2xl max-w-lg italic opacity-90 mb-6 md:mb-8">' + panel.desc + '</p>',
            '            ' + (panel.extraContent || ''),
            '            ' + linkHtml,
            '        </div>',
            '    </label>',
